...
$('.main .information-container .list .item .name').on('click', function () {
...
$('.server-chat-5-29').height(window.innerHeight - $('.vip-center-my-account').innerHeight() - $('.server-5-29').innerHeight())